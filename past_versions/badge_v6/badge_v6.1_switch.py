...
#-------------- should flash something to indicate
    ...
    #needs attention: returns a number that is assigned to different distances in meters
    #only used by get_distance_feedback()
