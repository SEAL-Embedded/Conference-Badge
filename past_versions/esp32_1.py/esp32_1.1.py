...
#Have more fields (do this!!!) 

#I wanted to make the badge search for the match until the user presses the button or something,
#so both: the switch to turn on the tracking thing and a button - to stop searching for the match
#also, there should be different colors
#the way we set up the badges matters too TT
# but this is the next badge iteration problem
